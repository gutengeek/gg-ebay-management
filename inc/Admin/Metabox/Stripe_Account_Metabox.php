...
class Stripe_Account_Metabox extends Metabox {
	...
	public function get_settings() {
		...
		$settings = [
			...
			// Live
			[
				'name'        => esc_html__( 'Live Mode', 'ggem' ),
				'id'          => $prefix . 'live_title',
				'type'        => 'title',
				'description' => sprintf( __( 'You must add the following webhook endpoint <strong style="background-color:#ddd;">&nbsp;%s&nbsp;</strong> to your <a href="https://dashboard.stripe.com/account/webhooks" target="_blank">Stripe account settings</a>. This will enable you to receive notifications on the charge statuses.', 'ggem' ), \WC_Stripe_Helper::get_webhook_url() ),
			],
			[
				'name'        => esc_html__( 'Live Publishable Key', 'ggem' ),
				'id'          => $prefix . 'publishable_key',
				'type'        => 'text',
				'description' => esc_html__( 'Get your API keys from your stripe account. Invalid values will be rejected. Only values starting with "pk_live_" will be saved.', 'ggem' ),
			],
			[
				'name'        => esc_html__( 'Live Secret Key', 'ggem' ),
				'id'          => $prefix . 'secret_key',
				'type'        => 'password',
				'description' => esc_html__( 'Get your API keys from your stripe account. Invalid values will be rejected. Only values starting with "sk_live_" or "rk_live_" will be saved.', 'ggem' ),
			],
			[
				'name'        => esc_html__( 'Webhook Secret', 'ggem' ),
				'id'          => $prefix . 'webhook_secret',
				'type'        => 'password',
				'description' => esc_html__( 'Get your webhook signing secret from the webhooks section in your stripe account.', 'ggem' ),
			],
			// Test
			[
				'name'        => esc_html__( 'Test Mode', 'ggem' ),
				'id'          => $prefix . 'test_title',
				'type'        => 'title',
				'description' => sprintf( __( 'You must add the following webhook endpoint <strong style="background-color:#ddd;">&nbsp;%s&nbsp;</strong> to your <a href="https://dashboard.stripe.com/account/webhooks" target="_blank">Stripe account settings</a>. This will enable you to receive notifications on the charge statuses.', 'ggem' ), \WC_Stripe_Helper::get_webhook_url() ),
			],
			[
				'name'        => esc_html__( 'Test Publishable Key', 'ggem' ),
				'id'          => $prefix . 'test_publishable_key',
				'type'        => 'text',
				'description' => esc_html__( 'Get your API keys from your stripe account. Invalid values will be rejected. Only values starting with "pk_test_" will be saved.', 'ggem' ),
			],
			[
				'name'        => esc_html__( 'Test Secret Key', 'ggem' ),
				'id'          => $prefix . 'test_secret_key',
				'type'        => 'password',
				'description' => esc_html__( 'Get your API keys from your stripe account. Invalid values will be rejected. Only values starting with "sk_test_" or "rk_test_" will be saved.', 'ggem' ),
			],
			[
				'name'        => esc_html__( 'Test Webhook Secret', 'ggem' ),
		...
		return apply_filters( 'ggem_stripe_fields_options', $settings );
	}
}
