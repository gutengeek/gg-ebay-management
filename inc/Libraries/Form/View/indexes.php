...
?>
    ...
    <div class="js-ggem-metabox-wrap metabox-panel-wrap">
        <div class="ggem-tab ggem-tab-verticle">
            <ul class="ggem-form-data-inline-tabs ggem-metabox-inline-tabs ggem-tab-head">
                        ...
                        <a href="#<?php echo $form_data_tab['id']; ?>"
                           data-tab-id="<?php echo $form_data_tab['id']; ?>">
                            ...
                            <?php else : ?>
                                <span class="ggem-icon ggem-icon-default"></span>
                            <?php endif; ?>
                            <span class="ggem-label"><?php echo $setting['title']; ?></span>
                        </a>
                     </div>
                ...
                <?php if ( $this->has_sub_tab( $setting ) ) : ?>
                    <?php if ( ! empty( $setting['sub-fields'] ) ) : ?>
                        <?php foreach ( $setting['sub-fields'] as $index => $sub_fields ) : ?>
                            <div id="<?php echo $sub_fields['id']; ?>" class="panel ggem_options_panel ggem-hidden ggem-panel">
