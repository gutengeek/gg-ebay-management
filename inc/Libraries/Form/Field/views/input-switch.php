...
$defaults = [
	...
	'name'        => '',
	'description' => null,
	'class'       => 'ggem-switch form-control',
	'wrap_class'  => '',
	'data'        => [],
	'disabled'    => false,
	'default'     => '',
...
$output .= '<div class="ggem-field-wrap ggem-switch-field-wrap form-group ' . $wrap_class . '" id="' . sanitize_key( $this->form_id . $args['id'] ) . '-wrap">';

if ( $args['name'] ) {
	$output .= '<label class="ggem-label" for="' . sanitize_key( $this->form_id . $args['id'] ) . '">' . esc_html( $args['name'] ) . '</label>';
}
$output .= '<div class="ggem-field-main">';
$output .= '<label class="ggem-switch-input">';
