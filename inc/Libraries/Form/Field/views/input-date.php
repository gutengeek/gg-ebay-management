...
$defaults = [
	...
	'description'     => null,
	'placeholder'     => '',
	'class'           => 'ggem-datepicker regular-text form-control',
	'data'            => false,
	'disabled'        => false,
	'date_format'     => '',
	'date_storage'    => '',
...
$output = '<div class="ggem-field-wrap ggem-date-field-wrap form-group" id="' . sanitize_key( $this->form_id . $args['id'] ) . '-wrap">';
if ( $args['show_label'] ) {
